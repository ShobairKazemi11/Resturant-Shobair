...
const displayDishesForManagement = () => {
    ...
    dishes.forEach((dish) => {
        ...
        dishElement.innerHTML = `
            ...
            <div class="dish-actions">
              <button class="admin-btn btn-outline edit-dish" data-id="${dish.id
            }">
                <i class="fas fa-edit"></i> Edit
              </button>
              <button class="admin-btn btn-outline remove-dish" data-id="${dish.id
    ...
    cart.forEach((item, index) => {
        ...
        div.innerHTML = `
          ...
          <div class="cart-item-details">
            <h4>${item.name}</h4>
            <p class="cart-item-price">$${item.price.toFixed(2)} × ${item.quantity || 1
